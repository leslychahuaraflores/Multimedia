package com.lesly.mantenimiento;
...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnIngresar = (Button) findViewById(R.id.btnEntrar);
        ...
        btnIngresar.setOnClickListener(new View.OnClickListener(){
            ...
            public void  onClick(View view){
                ...
                if (usuario.equals("Admin")&& password.equals("123456")){
                    Intent newform =new Intent(Login.this, com.lesly.mantenimiento.Register.class);
